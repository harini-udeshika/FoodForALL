        ...
        <div class="shop-item-container">
            <?php 
                ...
                if($count>0){
                        ...
                        ?>
                            ...
                            <div class="child-shop-item" >
                                ...
                                <p style="margin-top: 2px;">
                                        ...
                                        <p class='item-text-3' style="font-weight: bold;">Stock : <?php echo $stock; ?></p></p><br><br><br>
                    ...
                    echo "<div style='font-family:'consolas'; text-align:center; font-size: 35px; font-weight: bold; color: black;'>";
                    echo "Your Shop is Empty</div>";
                }
            ?>
