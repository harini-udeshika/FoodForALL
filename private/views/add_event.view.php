...
<div class="body-container">
        <div class="container">
                ...
                <div class="grid-10 col-lg-10 p-20">
                        ...
                        <div class="card card-back1 col-lg-4 height-600px p-left-20">
                                <div class="heading-1 col-4 p-top-20 p-bottom-20">Add Events</div>
                                <form method="post" action="" class="p-top-10 p-left-80 p-right-5">
                                        ...
                                        <button class="btn btn-sm btn-black float-right m-top-10 m-right-20" type="submit">Add Event</button>
                                        <a href="home_org/event">
                                                <button class="btn btn-sm btn-black float-left m-top-10" style="margin-left: -70px;" type="button">Back</button>
                                        </a>
