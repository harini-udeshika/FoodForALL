    ...
    <div class="box center">
        ...
        <div class="form-box" style="height: 850px; margin-bottom:30px;">
            ...
            <div class="eminput-control">
                <input type="text" value="<?=get_var('organization')?>"
                name="organization" id="name-org" placeholder="Name" >
                <br>
            ...
            <div class="eminput-control">
                <input type="email"
                value="<?=get_var('email')?>"
                name="email" id="email-org" placeholder="Email" >
                <br>
            ...
            <div class="eminput-control">
                <input type="text" value="<?=get_var('gov_no')?>" 
                name="gov_no" id="gov-org" placeholder="Gov. Registration No" >
                <br>
                <h4 style="font-size: 15px; text-align:left; color:red; margin-top: -15px; padding-top: 15px;
                padding-bottom:-5px; margin-bottom:0px;"><?php  
            ...
            <div class="eminput-control">
                <input type="text" value="<?=get_var('tel')?>"
                name="tel" id="tel-org" placeholder="Telephone Number" >
                <br>
                <div class="client-error"></div>
            </div>

            <div class="eminput-control">
                <input type="text" value="<?=get_var('address')?>"
                name="address" id="address-org" placeholder="Address" >
                <br>
                <div class="client-error"></div>
            </div>
            ...
            <table style="float: left;">
                ...
                <div class="eminput-control">
                <input type="text" value="<?=get_var('postal-code')?>"
                name="postal-code" id="postal-code-org" placeholder="Postal code" style="width: 90%;">
                <br>
                    <div class="client-error"></div>
                </div>  
                </td>
            ...
            <div class="eminput-control">
                ...
                <button type="submit" class="loginbtn" id="create"
